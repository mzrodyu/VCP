...
const Home = () => {
  ...
  const sideFeatures = [
    ...
    {
      icon: <IconLineChartStroked className="text-blue-500" style={{ fontSize: 20 }} />,
      title: t('统一监控'),
  ...
  const features = [
    ...
    {
      icon: <IconLineChartStroked className="text-blue-500" style={{ fontSize: 24 }} />,
      title: t('全栈可观测与风控'),
    ...
    {
      icon: <IconCodeStroked className="text-blue-500" style={{ fontSize: 24 }} />,
      title: t('开发者友好体验'),

...
const SmartHome = () => {
  ...
  const [acTemp, setAcTemp] = useState(19);
            ...
            <div className="device-card purifier-card">
              <div className="card-header">
                <div className="device-icon purifier-icon">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
                    <path d="M19.5 10c.17 0 .33.03.5.05V1L1 20h13.05c.02-.17.05-.33.05-.5 0-1.93 1.57-3.5 3.5-3.5.17 0 .33.03.5.05V13.5c0-1.93 1.57-3.5 3.5-3.5zM4.5 18L17 5.5V10c-1.93 0-3.5 1.57-3.5 3.5 0 .17.03.33.05.5H4.5z"/>
                  </svg>
                </div>
